<?php
	...
	$sql_status=mysqli_query($con, "UPDATE facturas SET id_cliente = '$id_cliente', compra = '$compra',cotizacion = '$cotizacion',
	doctor = '$doctor',paciente = '$paciente',material = '$material',pago = '$pago',
	d_factura = '$d_factura', observaciones = '$observaciones', status_fact = 1,  hospital = '$hospital', 
	no_proveedor = '$proveedor' WHERE numero_factura = '$numero_factura' and id_vendedor = '$id_vendedor'");
