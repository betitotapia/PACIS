...
include(dirname(__FILE__).'/res/ver_recepcion_html.php');
?>

<input type="hidden" id="folio_recepcion" value="<?php echo $folio; ?>">

<script>
// Cuando cargue la página, mandar a pdf con html2pdf
window.onload = function () {
    var folio = document.getElementById('folio_recepcion').value;
    if (typeof toPdfRecepcion === 'function') {
        toPdfRecepcion(folio);
    } else {
        console.error('Función toPdfRecepcion no encontrada');
    }
};
</script>
