      ...
      <td>
        <table width="800" border="0" cellpadding="0" cellspacing="0" align="center" class="fullTable" bgcolor="#ffffff">
          <tbody>
			...
			$sql=mysqli_query($con, "SELECT f.id_detalle, f.numero_factura, f.id_producto, f.cantidad, f.precio_venta,f.id_vendedor,f.iva, f.referencia AS referencia_mostrada,
