...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($accion === 'crear') {
    ...
    if ($serie === '') {
      ...
      $ins = mysqli_query($con, "INSERT INTO facturacion_series (serie, descripcion, folio_actual, activo, created_at)
  ...
  if ($accion === 'editar') {
    ...
    if ($id_serie <= 0) {
      ...
      $desc_sql = mysqli_real_escape_string($con, $descripcion);
      $upd = mysqli_query($con, "UPDATE facturacion_series
...
$series = mysqli_query($con, "SELECT * FROM facturacion_series ORDER BY serie ASC");
      ...
      <div class="container-fluid">
        ...
        <div class="card card-primary card-outline">
          <div class="card-header">
            <h4 class="m-0">Configuracion de series de facturacion</h4>
          </div>
          <div class="card-body">
              ...
              <div class="card-body">
                <form method="post" class="row g-2">
                  ...
                  <div class="col-md-2">
                    ...
                    <input type="text" maxlength="10" class="form-control" name="serie" placeholder="A" required>
                  </div>
                  <div class="col-md-6">
                    <label class="form-label">Descripcion</label>
                    <input type="text" class="form-control" name="descripcion" placeholder="Factura principal Cancun">
                  </div>
                  <div class="col-md-2">
