...
<?php
			...
			?>
 <script>Swal.fire("Error!", "Esta remision ya esta facturada, no se puede cancelar!", "error");</script> 
<?php
...
<div class="table-responsive">
    <table class="table  table-striped" id="myTable">
        <tr class="info">
            ...
            <th class="d-md-table-cell">Status en Sistema</th>
            <?php
        ...
        <tr>
            ...
            <td class="d-none d-md-table-cell"><a href="#" style='color:white'
...
if ($rj_usuario['is_admin'] == 1){
	...
	echo "
    <a href='#' class='btn btn-default bg_icons-purple btn-scale'
        title='Ver factura'
        onclick='ver_factura(".$id_factura.",".$numero_factura.",".$id_ventas.");'>
        <ion-icon name=\"eye-outline\" class=\"icons-white\"></ion-icon>
    </a>

    <a href='#' class='btn btn-default bg_icons-gray btn-scale'
        title='Descargar factura'
        onclick='imprimir_factura(".$id_factura.",".$numero_factura.",".$id_ventas.");'>
        <ion-icon name=\"download-outline\" class=\"icons-white\"></ion-icon>
    </a>

    <a href='#' class='btn btn-default bg_icons-gray btn-scale'
        title='Imprimir remisión'
        onclick='imprimir_directo(".$id_factura.",".$numero_factura.",".$id_ventas.");'>
